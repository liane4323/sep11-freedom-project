...
* Link of the website: https://twikito.github.io/easy-toggle-state/demo 
  ...
  * Later on, I officially came up with 1 feature that I will be using in my website. The feature is called **"Radio buttons"**. I chose this feature because it looks like an answer choice section from a quiz. As you can see in the picture below: 
